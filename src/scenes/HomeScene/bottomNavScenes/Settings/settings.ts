...
export function useDangerousSettingsSection(): SettingSectionPresenter {
  const navigation = useDexifySettingsNavigation();
  const clearDataSetting: PressableSetting = {
    type: 'pressable',
    title: 'Reset data',
    subtitle:
      'Clear all data generated by your use of the app, resetting the app to its default settings.',
    icon: 'chevron-right',
    onPress: () => {
